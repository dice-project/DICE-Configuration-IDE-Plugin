...
public class ServiceBuilder {
		...
		public Service add(int i, Text t) {
			switch (i) {
			case 1: return withURL(t);
			case 2: return withIP(t);
			case 3: return withContainer(t);
			case 4: return withUsername(t);
			case 5: return withPassword(t);
			case 6: return withTools(t);
			case 7: return withStorm(t);
			}
			return s; 
		}
